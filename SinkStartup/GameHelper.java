...
public class GameHelper {
    ...
    public ArrayList<String> placeStartup(int startupSize) {
        ...
        int increment = getIncrement(); // alternate vert & horz alignment

        while (!success & attempts++ < MAX_ATTEMPT); { // main search loop 
    ...
    private String getAlphaCoordsFromIndex(int index) {
        ...
        int column = index % GRID_LENGTH; // get column value
